  ...
  describe '#player_input' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        invalid_input_b = '$'
        valid_input = '3'
        allow(game_input).to receive(:gets).and_return(invalid_input_a, invalid_input_b, valid_input)
      end
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        input = 3
        verified_input = verify_game.verify_input(min, max, input)
        expect(verified_input).to be(3)
      end
    end
