...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    ...
    context 'when the input "random" number 5 is chosen' do
  ...
  describe '#play' do
    context 'when the random number is 9' do
      ...
      it 'will return 7' do
        expect(game.play).to be(7)
      end
    end

    context 'when the random number is 222' do
      subject(:game) { described_class.new(222) }
      # remove the 'x' before running this test
      it 'will return 7' do
        expect(game.play).to be(7)
      end
    ...
    context 'when the random number is -41' do
      subject(:game) { described_class.new(-41) }
      # remove the 'x' before running this test
      it 'will return 7' do
        expect(game.play).to be(7)
      end
